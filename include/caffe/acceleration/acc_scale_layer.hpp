#ifndef CAFFE_ACC_SCALE_LAYER_HPP_
#define CAFFE_ACC_SCALE_LAYER_HPP_
...
class AccScaleLayer: public Layer<Dtype> {
 public:
  explicit AccScaleLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "AccScale"; }
  // AccScale
