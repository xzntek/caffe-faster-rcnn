#ifndef CAFFE_ACC_BATCHNORM_LAYER_HPP_
#define CAFFE_ACC_BATCHNORM_LAYER_HPP_
 ...
 * the AccBatchNorm layer's output.
 *
...
class AccBatchNormLayer : public Layer<Dtype> {
 public:
  explicit AccBatchNormLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "AccBatchNorm"; }
