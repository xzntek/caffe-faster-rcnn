#ifndef CAFFE_SINGLE_BATCHNORM_LAYER_HPP_
#define CAFFE_SINGLE_BATCHNORM_LAYER_HPP_
 ...
 * the SingleBatchNorm layer's output.
 *
...
class SingleBatchNormLayer : public Layer<Dtype> {
 public:
  explicit SingleBatchNormLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "SingleBatchNorm"; }
...
#endif  // CAFFE_SINGLE_BATCHNORM_LAYER_HPP_
