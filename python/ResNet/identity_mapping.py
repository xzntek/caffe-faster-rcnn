...
def parse_args():
    ...
    parser.add_argument('--lmdb_train', dest='lmdb_train',
                        ...
                        default='examples/cifar10/cifar10_train_lmdb_pad_4', type=str)
    parser.add_argument('--lmdb_test', dest='lmdb_test',
                        help='test lmdb data',
                        default='examples/cifar10/cifar10_test_lmdb_pad_4', type=str)
    parser.add_argument('--mean_file', dest='mean_file',
                        help='overlap value',
                        default='examples/cifar10/pad_4_mean.binaryproto', type=str)
    ...
    parser.add_argument('--bottleneck', dest='bottleneck',
                        help='bottleneck or not, using True or False',
