...
$BUILD --gpu $gpu \
    ...
    --weights matlab/FRCNN/For_LOC/two/googlenet_v1/googlenet_v1_faster_rcnn_final.caffemodel \
    ...
    --out_file matlab/FRCNN/For_LOC/googlenet_v1/out/2_test_list_googlenet_v1_${pid}.frcnn \
    --max_per_image 100
